...
(function () {
  ...
  function streetLamp(b, x, z, h, ry) {
    const A=window.DestructibleAuthoring,kind=h<=16?'retailStreetLamp16':'retailStreetLamp17';
    if(A)A.add('neon',{kind:kind,x:x,y:0,z:z,ry:ry||0,s:1});
    else{pole(b,x,z,h);headWarm(b,x,z,h-.6,ry);}
  }
  ...
  function lotLight(b, x, z) {
    ...
    if(A)A.add('neon',{kind:'retailLotFloodlight',x:x,y:0,z:z,ry:0,s:1});
    else{pole(b,x,z,26);headCool(b,x,z-2.6,25.2,0);headCool(b,x,z+2.6,25.2,0);}
  }
  ...
  function build(b) {
    ...
    b.landmark('CANYON MOTORS', 1810, 760);
  }
  ...
  function boulevardDressing(b, r) {
    ...
    for (let x = BLV_X0 + 20; x <= BLV_X1 - 10; x += 92) {
      ...
      const A=window.DestructibleAuthoring;
      if(A)A.add('neon',{kind:'retailMedianLamp',x:px,y:0,z:BLV_Z,ry:0,s:1});
  ...
  function motel(b, r) {
    ...
    for (const px of [3552,3648]) { const A=window.DestructibleAuthoring;if(A)A.add('neon',{kind:'retailLamp9',x:px,y:0,z:-412,ry:0,s:1}); }
  ...
  function serviceYard(b, r) {
    ...
    for (const px of [2360,2560,2760]) { const A=window.DestructibleAuthoring;if(A)A.add('neon',{kind:'retailLamp18',x:px,y:0,z:-556,ry:0,s:1}); }
  ...
  function usedCarLot(b, r) {
    ...
    for (let row = 0; row < 4; row++) {
      ...
      const A=window.DestructibleAuthoring;
      if(A){A.add('neon',{kind:'retailLamp14',x:1552,y:0,z:z-26,ry:0,s:1});A.add('neon',{kind:'retailLamp14',x:2066,y:0,z:z-26,ry:0,s:1});}
    }
  ...
  function driveIn(b, r) {
    ...
    for (const px of [3444,3878]) { const A=window.DestructibleAuthoring;if(A)A.add('neon',{kind:'retailLamp20',x:px,y:0,z:720,ry:0,s:1}); }
  }

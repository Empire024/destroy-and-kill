...
(function () {
  ...
  function quarryProps(b, r) {
    ...
    function flood(x, z, h, ry) {
      const g=groundY(x,z),A=window.DestructibleAuthoring;
      if(A)A.add('neon',{kind:'quarryFloodlight',x:x,y:g,z:z,ry:ry||0,s:h/21});
      else b.instance('qMast',barGeo,mastMat,{x:x,y:g+h/2,z:z,sx:1.6,sy:h,sz:1.6});
    }

...
(function () {
  ...
  function buildVillas(b, r) {
    ...
    b.road([start,p1,p2,p3,summit],{width:48,color:0x242d38,curbColor:0x788896,lineColor:0xffd27b,deck:true});
    function deckYAt(x){const t=clamp01((x-start[0])/(summit[0]-start[0]));return start[2]+(summit[2]-start[2])*t;}
